...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an intelligent assistant helping users analyze the operation manuals and maintenance manuals of CSI Test bed, The documents contain text, graphs, tables and images.
